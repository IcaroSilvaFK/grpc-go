...
func (x *GetCategoryId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCategoryId) ProtoMessage() {}

func (x *GetCategoryId) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCategoryId.ProtoReflect.Descriptor instead.
func (*GetCategoryId) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{2}
}

func (x *GetCategoryId) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_proto_course_category_proto_rawDesc = []byte{
	...
	0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x12, 0x0e, 0x0a,
	...
	0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x69, 0x65, 0x73, 0x32, 0xc7, 0x02, 0x0a, 0x0f, 0x43,
	0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b,
	...
	0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x22, 0x00, 0x12, 0x47, 0x0a, 0x14, 0x43,
	...
	0x22, 0x00, 0x28, 0x01, 0x12, 0x47, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x42, 0x69, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x19,
	...
	0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x34,
	0x0a, 0x0f, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x42, 0x79, 0x49,
	0x64, 0x12, 0x11, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x79, 0x49, 0x64, 0x1a, 0x0c, 0x2e, 0x70, 0x62, 0x2e, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
...
var file_proto_course_category_proto_goTypes = []interface{}{
	...
	(*GetCategoryId)(nil),         // 2: pb.GetCategoryId
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	3, // 3: pb.CategoryService.CreateCategoryBiStream:input_type -> pb.CreateCategoryRequest
	0, // 4: pb.CategoryService.ListCategories:input_type -> pb.blank
	2, // 5: pb.CategoryService.GetCategoryById:input_type -> pb.GetCategoryId
