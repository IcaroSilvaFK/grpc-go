...
type CategoryServiceClient interface {
	...
	CreateCategoryBiStream(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBiStreamClient, error)
	ListCategories(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*CategoryList, error)
	GetCategoryById(ctx context.Context, in *GetCategoryId, opts ...grpc.CallOption) (*Category, error)
}
...
func (c *categoryServiceClient) CreateCategoryBiStream(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryBiStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryBiStreamClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryBiStreamClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryBiStreamClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryBiStreamClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBiStreamClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *categoryServiceClient) GetCategoryById(ctx context.Context, in *GetCategoryId, opts ...grpc.CallOption) (*Category, error) {
	out := new(Category)
...
type CategoryServiceServer interface {
	...
	CreateCategoryBiStream(CategoryService_CreateCategoryBiStreamServer) error
	ListCategories(context.Context, *Blank) (*CategoryList, error)
	GetCategoryById(context.Context, *GetCategoryId) (*Category, error)
...
func (UnimplementedCategoryServiceServer) CreateCategoryBiStream(CategoryService_CreateCategoryBiStreamServer) error {
...
func (UnimplementedCategoryServiceServer) GetCategoryById(context.Context, *GetCategoryId) (*Category, error) {
...
func _CategoryService_CreateCategoryBiStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryBiStream(&categoryServiceCreateCategoryBiStreamServer{stream})
}

type CategoryService_CreateCategoryBiStreamServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryBiStreamServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryBiStreamServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBiStreamServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _CategoryService_GetCategoryById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryById(ctx, req.(*GetCategoryId))
	}
	return interceptor(ctx, in, info, handler)
}
